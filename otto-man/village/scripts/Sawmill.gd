...
var building_name: String = "Kerestehane"
...
const PRODUCTION_TIME: float = 1650.0 # tam çalışma günü (07-18, 11 saat) = 1 işçi başına 1 kereste
...
func get_production_info() -> String:
	return tr("building.sawmill.production_info") % [level, assigned_workers]
