...
var building_name: String = "Tuğla Ocağı"
...
var required_resources: Dictionary = {"stone": 1}
var produced_resource: String = "brick"

var input_buffer: Dictionary = {"stone": 0}
var production_progress: float = 0.0
const PRODUCTION_TIME: float = 1650.0 # tam çalışma günü (07-18, 11 saat) = 1 işçi başına 1 tuğla
...
func get_production_info() -> String:
	return tr("building.brickworks.production_info") % [level, assigned_workers]
