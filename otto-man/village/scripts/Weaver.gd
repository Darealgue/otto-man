...
var building_name: String = "Dokuma Tezgahı"
...
var produced_resource: String = "cloth"

var input_buffer: Dictionary = {"wood": 0, "food": 0}
var production_progress: float = 0.0
const PRODUCTION_TIME: float = 1650.0 # tam çalışma günü (07-18, 11 saat) = 1 işçi başına 1 kumaş
...
func get_production_info() -> String:
	return "Lv." + str(level) + " • İşçi:" + str(assigned_workers) + " • Kumaş: (odun+yiyecek)"
